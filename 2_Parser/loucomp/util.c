  ...
  while (tree != NULL) {
    ...
    { switch (tree->kind.decl) {
        case VarK:
          ...
          break;
        case FunK:
          fprintf(listing,"Function declaration, name : %s, return ", tree->attr.var_name);
          break;
        case ArrVarK:
          fprintf(listing,"VarArr declaration, name : %s, size : %d, ", tree->attr.var_name, tree->attr.var_size);
          break;
        case TypeK:
